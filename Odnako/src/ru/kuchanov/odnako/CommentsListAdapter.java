...
public class CommentsListAdapter extends BaseAdapter
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		switch (type)
		{
			...
			case 2:
				...
				// FLAG
				DownloadImageTask downFlag = (DownloadImageTask) new DownloadImageTask((ImageButton) null, (ImageView) holderMain.flag, (Activity) act);
				downFlag.execute(p.flag);
				// FLAG

				// AVA
				DownloadImageTask downAva = (DownloadImageTask) new DownloadImageTask((ImageButton) null, (ImageView) holderMain.avaImg, (Activity) act);
	...
	public static void showCommView(Context context, CommentInfo p)
	{
		...
		// FLAG
		DownloadImageTask downFlag = (DownloadImageTask) new DownloadImageTask((ImageButton) null, (ImageView) flag, (Activity) context);
		downFlag.execute(p.flag);
		// FLAG

		// AVA
		DownloadImageTask downAva = (DownloadImageTask) new DownloadImageTask((ImageButton) null, (ImageView) ava, (Activity) context);
		downAva.execute(p.avaImg);
		// AVA
