...
public class JBTextView extends TextView
{
	...
	private static final String TAG = JBTextView.class.getSimpleName();
	Context context;

	public JBTextView(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
	}

	public JBTextView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}

	public JBTextView(Context context)
	{
		super(context);
	...
	public void setText(CharSequence text, BufferType type) {
		try{
			...
			//setText(getText().toString());
			//new ru.kuchanov.odnako.utils.SetTextViewHTML(context).SetText(this, getText().toString());
		}
	}
	...
	{
		setText(text);
//		new ru.kuchanov.odnako.utils.SetTextViewHTML(context).SetText(this, text.toString());
		super.onMeasure(widthMeasureSpec, heightMeasureSpec);
	}
