...
public class CatData
{
	 ...
	 * 
	 * @param act
	 * @return String array filled with links (urls) of catagories (and authors)
	 *         represented in drawer menu
	 */
	...
	public static ArrayList<String> getMenuLinksWithoutSystem(Context act)
	{
		ArrayList<String> allCategoriesMenuLinks = new ArrayList<String>();
		...
		{
			allCategoriesMenuLinks.add(authorsMenuLinks[i]);
		}
		for (int i = 0; i < categoriesMenuLinks.length - 2; i++)
		{
			allCategoriesMenuLinks.add(categoriesMenuLinks[i]);
		}
		return allCategoriesMenuLinks;
	}

	public static ArrayList<String> getMenuNamesWithoutSystem(Context act)
	{
		ArrayList<String> allCategoriesMenuLinks = new ArrayList<String>();

		String[] authorsMenuLinks = act.getResources().getStringArray(R.array.authors);
		String[] categoriesMenuLinks = act.getResources().getStringArray(R.array.categories);
