...
{
	final static String LOG = RecyclerAdapterAllCategories.class.getSimpleName() + "/";
	...
	public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position)
	{
		switch (getItemViewType(position))
		{
			...
			case (CATEGORY):
				...
				final int positionInAllArtsInfo = RecyclerAdapterAllCategories.getPositionInAllArtsInfo(position);
