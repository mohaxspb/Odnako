...
public class FragmentCommentDialog extends DialogFragment
{
	private AppCompatActivity act;

	private CommentInfo curCommentInfo;

	public static FragmentCommentDialog newInstance(CommentInfo curCommentInfo)
	{
		FragmentCommentDialog frag = new FragmentCommentDialog();
